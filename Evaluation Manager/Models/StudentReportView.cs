...
namespace Evaluation_Manager.Models
{
    public class StudentReportView
    {
        ...
        public StudentReportView(Student student)
        {
            ...
            var zadaca3 = evaluations.FirstOrDefault(e => e.Activity.Name == "Zadaca 3"); //vrati e za kojeg vrijedi da je naziv aktivnosti == DZ3
            ...
            Z3 = zadaca3 == null ? "-" : zadaca3.Points.ToString(); //Ako je zadaca null onda (?)...inače (:)... 
        }
    }
}
